...
export default function RocasPlayPage() {
    ...
    function mount() {
      ...
      intervalId = setInterval(() => {
        if (window.ASTEROIDS) {
          ...
          apiRef.current = window.ASTEROIDS.start(canvas, callbacks);
        }
      }, 50);

      timeoutId = setTimeout(() => {
        clearInterval(intervalId);
        console.error("Asteroids: window.ASTEROIDS not available after 5s");
      }, 5000);
    }
  ...
  function handleRestart() {
    const canvas = canvasRef.current;
    if (!canvas || !window.ASTEROIDS) return;
      ...
      <div className="av-player fade-in">
        <div className="player-hud">
          ...
          <div className="hud-actions">
            ...
            <button className="btn ghost" onClick={() => router.push("/games/rocas")}>SALIR</button>
          </div>
        </div>
          ...
          <div className="modal-bd">
            <div className="modal">
              ...
              <div className="actions">
                ...
                <button className="btn magenta" onClick={() => router.push("/games/rocas")}>VOLVER AL VAULT</button>
              </div>
            </div>
          </div>
        )}
